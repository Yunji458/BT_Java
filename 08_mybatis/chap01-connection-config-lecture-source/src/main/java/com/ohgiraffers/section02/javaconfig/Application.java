...
public class Application {
    ...
    private static String url =  "jdbc:mysql://localhost:3307/lecture";
    ...
    public static void main(String[] args) {
        ...
        SqlSession sesssion = sqlSessionFactory.openSession(false);   // 수동커밋

        Mapper mapper = sesssion.getMapper(Mapper.class);   // Mapper의 하위 구현체 생성
