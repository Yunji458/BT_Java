...
/* 설명.
  ...
  * 1. xml파일은 mapper용 인터페이스와 같은 이름으로 작성되어야 한다.
  * 2. xml파일은 mapper용 인터페이스와 같은 경로에 작성되어야 한다.
  * 3. xml파일의 namespace는 mapper용 인터페이로 작성되어야 한다. (feat.풀네임으로)
  * 4. xml파일의 쿼리 id와 추상메소드의 메소드명이 일치되어야 한다.
 */
