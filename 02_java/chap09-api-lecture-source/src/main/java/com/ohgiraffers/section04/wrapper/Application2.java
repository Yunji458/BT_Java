...
public class Application2 {
    public static void main(String[] args) {
        ...
        /* 수업목표. 문자열을 다양한 기본 지료형으로 바꿀 수 있다. */
        /* 설명. valueOf는 반환형이 각 Wrapper 클래스 타입의 객체이다.(auto-unboxing이 되어 기본자료향 대입 가능) */
...
//        char c = "abc".charAt(0);
        ...
        /* 설명. 코테 문제 풀 때는 이래와 같은 형태가 조금이라도 더 속도 측면에서 유리할 수 있다.
        *   (이유는 기본 자료형을 처음부터 반환해주어 auto-boxing을 하지 않기 떄문)
        * */
