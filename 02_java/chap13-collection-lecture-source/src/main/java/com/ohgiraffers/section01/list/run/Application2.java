...
public class Application2 {
    public static void main(String[] args) {
        ...
        /* 수업목표. ArrayList에서 관리되는 자료형의 정렬기준을 이용할 수 있다. (Comparable or Comparator) */
        ...
        bookList.add(new BookDTO(5, "삼국유사", "일연", 540000));
...
//        System.out.println("bookList = " + bookList);
        ...
        /* 설명. Compareable 인터페이스를 구현한 해당 클래스 기준 정렬 외에도 Comparator를 구현한 별도의 정렬 기준도 가능 */
