...
/* 설명.
 *  의존성 역전 원칙(Dependency Inversion Principle) - "자식에게 의존하면 자식 떄문에 휘둘려!"
...
public class Application {
    public static void main(String[] args) {
        ...
        badService.sendNotification(1, "중요 공지사함입니다.");   // 1은 email
        badService.sendNotification(2, "중요 공지사함입니다.");   // 2은 SMS
    }
