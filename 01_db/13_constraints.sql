...
(user_no, user_id, user_pwd, user_name, gender, phone, email)
VALUES
(2, 'user01', 'pass01', '홍길동', '남', '010-123-1234', 'hong123@gmail.com');
...
CREATE TABLE if NOT EXISTS user_check (
    ...
    age INT,
	 CHECK(age >= 19 AND age <= 30)                       -- , check ... 도 가능하지만 통일성은 맞춰주는것이 좋음
);
...
CREATE TABLE if NOT EXISTS tbl_country (
    counrty_code INT AUTO_INCREMENT PRIMARY KEY,
