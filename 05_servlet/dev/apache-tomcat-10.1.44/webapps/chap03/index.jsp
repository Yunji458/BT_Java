...
<%--        option*4--%>
    ...
    <h4>a태그의 href 속성에 직접 피라미터를 쿼리스트링 형태로 작성하고 get 요청을 할 수도 있다.</h4>
    <a href="http://localhost:8080/chap03/querystring?name=%ED%99%8D%EA%B8%B8%EB%8F%99&age=12&birthday=2025-09-11&gender=M&national=ko&hobbies=movie&hobbies=music&hobbies=sleep">
        a태그 활용
    </a>
